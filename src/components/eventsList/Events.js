      ...
      <div className='page-header'>
        <div className='container'>
          <div className='ph-inner-wrapper'>
            <h3 className='title'>Events List</h3>
          </div>
        </div>
      </div>
          ...
          <div className='container section'>
            ...
            <div className='events'>
              <div className='next-event-countdown'>
                <ul
                  className='events-home-countdown start_countdown clearfix'
            ...
            <div className='btn-wrapper pdt-70 multiple-btn'>
              <a href='events-list.html' className='btn first'>
                <i className='fa fa-th'></i>All Events
              </a>
              <a href='events-masonry.html' className='btn orange'>
                <i className='fa fa-clock-o'></i>Past Events
              </a>
            </div>
          </div>
        </div>
